...
//   }
   ...
   private static Connection getConn() throws AppException {
      try {
         ...
         props.load(CapsJdbc.class.getClassLoader().getResourceAsStream("appconf.properties"));
         ...
         String url = String.format("jdbc:mysql://%s:%s/%s?useSSL=false&characterEncoding=utf8&autoReconnect=true",dbhost,dbport,db);
         Connection conn =
   ...
   public static void main(String[] args) throws Exception {
      ...
      CapsRes res = execSQL("select * from dept", null);
